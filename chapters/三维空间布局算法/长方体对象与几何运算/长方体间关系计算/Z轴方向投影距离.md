...
# Z轴投影距离（核心函数）
# ==========================================================
def distance_z_projection(cuboid1, cuboid2):
    """
    计算两个长方体中心点在 Z 轴方向的投影距离
    """

    _, _, z1 = cuboid1.base_center()
    _, _, z2 = cuboid2.base_center()
...
# 计算Z轴投影距离
# ==========================================================
print("Z轴投影距离：", distance_z_projection(cuboid1, cuboid2))
